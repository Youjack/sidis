...
# pdf = lhapdf.mkPDF("MSTW2008lo68cl/0")
# ff  = lhapdf.mkPDF("DSS07_pion_plus_lo/0")
pdf = lhapdf.mkPDF("wwsidis_pdf/0")
ff  = lhapdf.mkPDF("wwsidis_ff_pi+/0")
def PhT2_avg(zh):
